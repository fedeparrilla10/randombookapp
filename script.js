...
function randomPage() {
  ...
  img.addEventListener("click", () => {
    if (title.textContent === "El Imperio Final") {
      location.href =
        "https://www.goodreads.com/book/show/7183286-el-imperio-final?ref=nav_sb_ss_1_16";
    } else if (title.textContent === "Neverwhere") {
      location.href =
        "https://www.goodreads.com/book/show/14497.Neverwhere?ref=nav_sb_ss_1_11";
    } else if (title.textContent === "El Nombre del Viento") {
      location.href =
        "https://www.goodreads.com/book/show/6483211-el-nombre-del-viento?ref=nav_sb_ss_1_20";
    }
  });
}
